...
namespace Slate
{
    ...
    public class Cutscene : MonoBehaviour, IDirector
    {
        ...
        public const float VERSION_NUMBER = 2.25f;
        ...
        [HideInInspector]
        public List<CutsceneGroup> groups = new();
        ...
        [System.NonSerialized]
        private static readonly Dictionary<string, Cutscene> allSceneCutscenes = new();
        [System.NonSerialized]
        ...
        public DirectorGroup directorGroup {
            get
            {
                ...
                if ( groups.Count > 0 && groups[0] is DirectorGroup group ) {
                    return group;
                }
        ...
        void DirectorSectionReached(Section section) {
            ...
            OnSectionReached?.Invoke(section);
        }
        ...
        */
        ...
        public static Cutscene FindFromResources(string name) {
            ...
            if ( go != null ) {
                if ( go.TryGetComponent<Cutscene>(out var cut) ) {
                    return cut;
                }
            }
        ...
        public static Cutscene Find(string name) {
            if ( allSceneCutscenes.TryGetValue(name, out Cutscene cutscene) ) {
                return cutscene;
            }
        ...
        public void SendGlobalMessage(string message, object value = null) {
            ...
            OnGlobalMessageSend?.Invoke(message, value);
        ...
        public static Cutscene Create(Transform parent = null) {
            ...
            cutscene.transform.SetLocalPositionAndRotation(Vector3.zero, Quaternion.identity);
            return cutscene;
        }
