...
namespace Slate
{
    ...
    public class DirectorGUI : MonoBehaviour
    {
        ...
        public static DirectorGUI current {
            get
            {
                if ( _current == null ) {
                    ...
                    _current = FindAnyObjectByType<DirectorGUI>();
        ...
        void OnDisable() {
            ...
            UpdateOverlayText(null, Color.clear, 0, default, Vector2.zero);
        ...
        public static void UpdateLetterbox(float completion) {
            OnLetterboxGUI?.Invoke(completion);
        }

        //...
        public static void UpdateDissolve(Texture texture, float completion) {
            OnCameraDissolve?.Invoke(texture, completion);
        }
